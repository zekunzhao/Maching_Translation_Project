...
def evaluate(encoder, decoder, sentence, max_length=MAX_LENGTH):
    with torch.no_grad():
        ...
        # # print(str(second_n.currentList)+"score = "+str(score))
        # return utterance
...
# encoder1.load_state_dict(torch.load("data/model/backup/pro_model/pro_encoder1"))
# attn_decoder1.load_state_dict(torch.load('data/model/backup/pro_model/pro_attn_decoder1'))
