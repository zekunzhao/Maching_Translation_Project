...
pairs, v_pairs = partition(pairs,0.8)
...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
    ...
    val_pairs = [tensorsFromPair(random.choice(v_pairs))
    ...
    for iter in range(1, n_iters + 1):
        ...
        if iter % print_every == 0:
            ...
            if val_loss_pre < val_loss:
                print("**********************Congraduation!!!!!********************")
                break

            val_loss_pre = val_loss
            torch.save(encoder1.state_dict(),'data/model/encoder1')
...
trainIters(encoder1, attn_decoder1, 175000, print_every=500, learning_rate=0.01)
# 75000*2
# print(evaluateRandomly(encoder1, attn_decoder1,100))
