...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
    ...
    for iter in range(1, n_iters + 1):
        ...
        if iter > n_iters/2:
            currentbleu = evaluateRandomly(encoder1, attn_decoder1,100)
            if currentbleu < best_bleu-0.01:
                return
            else:
                best_bleu = currentbleu
                print("ave_bleu : ", best_bleu)
...
def evaluateRandomly(encoder, decoder, n=100):
    ...
    for i in range(n):
        ...
        score += sentence_bleu(candidates, pair[1] )
    return score/n
...
# trainIters(encoder1, attn_decoder1, 30000, print_every=500, learning_rate=0.01)
# 75000*2
