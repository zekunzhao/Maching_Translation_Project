...
Original file is located at
    https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/05baddac9b2f50d639a62ea5fa6e21e4/torchtext_translation_tutorial.ipynb
"""
...
for epoch in range(N_EPOCHS):
    ...
    torch.save(model.state_dict(),f'saved_models/model_{epoch+1:02}_{valid_loss:.3f}')
